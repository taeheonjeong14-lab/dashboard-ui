...
export default function PlaceInflowSection({
  ...
  return (
    <section
      ...
      className="border-b border-zinc-800 bg-zinc-950 p-4 sm:p-5 lg:col-span-2 lg:border-l lg:border-zinc-800"
    >
      <h2 id="place-inflow" className="mb-2 text-base font-semibold text-zinc-100 sm:text-lg">
        플레이스 유입수
      </h2>
      <p className="mb-3 text-sm text-zinc-500">기간 내 플레이스 유입수 추이입니다.</p>
              ...
              {(
                ...
                <button
                  ...
                  className={`px-2.5 py-1 text-xs ${
                    granularity === g ? "bg-zinc-100 text-zinc-900" : "text-zinc-400 hover:text-zinc-200"
                  }`}
                >
                  {label}
                </button>
                    ...
                    return (
                      <div className="rounded border border-zinc-700 bg-zinc-950 px-2.5 py-1.5 text-xs shadow-lg">
                        ...
                        <p className="text-zinc-100">
                          유입수 <span className="text-zinc-300">{formatNumber(Number.isFinite(n) ? n : null)}명</span>
                        </p>
                      </div>
                    );
                  }}
