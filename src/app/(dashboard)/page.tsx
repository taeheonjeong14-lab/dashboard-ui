  ...
  return (
    <main className="w-full max-w-none px-4 py-4 sm:px-5 sm:py-5 lg:px-6">
      ...
      <div className="mt-3 flex flex-col divide-y divide-zinc-800 border border-zinc-800 bg-zinc-800">
        ...
        <section aria-labelledby="summary-blog-rank" className="bg-zinc-950 p-4 sm:p-5">
          <h2 id="summary-blog-rank" className="mb-2 text-base font-semibold text-zinc-100 sm:text-lg">
            주요 키워드 · 블로그 노출 순위
          </h2>
          <p className="mb-3 text-sm text-zinc-500">
